...
[InitializeOnLoad]
public class GitDirCleaner
{
    const string hooksFolder = "hooks~";
    const string intallKey = "git_hooks_installed";
    const int version = 5;
    ...
    [MenuItem("Tools/Git Helper/Install Hooks")]
    public static void InstallHooks()
    {
        ...
        if (gitDir.Length != 0)
        {
            ...
            EditorPrefs.SetInt(intallKey, version);
    ...
    {
        int instaledVersion = EditorPrefs.GetInt(intallKey);
